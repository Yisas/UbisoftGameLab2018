...
#if defined(SHADER_API_D3D11) || defined(SHADER_API_XBOXONE) || defined(SHADER_API_PSSL) //defined(UNITY_COMPILER_HLSLCC) Not clear what sampling each one can use. But this setup works for metal/opengl/dx9/dx11
#if defined(NGSS_USE_BIAS_FADE) //NGSS SUPPORT as it delcares shadow maps differently then unity...
